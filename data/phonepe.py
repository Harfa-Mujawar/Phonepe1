...
conn = mysql.connector.connect(user='root', password='Harfa@24', host='127.0.0.1', database="phonepe")
...
if SELECT == "Home":
    col1,col2, = st.columns(2)
    col1.image(Image.open(r"C:\Users\itech\Desktop\data\phonepe.png"),width = 500)
    with col1:
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video(r"C:\Users\itech\Desktop\data\pulse-video.mp4")
    with col2:
        st.image(Image.open(r"C:\Users\itech\Desktop\data\PhonePe_Logo.jpg"),width = 500)
        st.write("---")
...
if SELECT == "Contact":
    ...
    col3.image(Image.open(r"C:\Users\itech\Desktop\data\my.jpg"), width=350)
    with col2:
