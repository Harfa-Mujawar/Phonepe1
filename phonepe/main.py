...
conn = mysql.connector.connect(user='root', password='Harfa@24', host='localhost', database='phonepe')
...
if SELECT == "Home":
    col1,col2, = st.columns(2)
    col1.image(Image.open(r"C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\phonepe.png"),width = 500)
    with col1:
    ...
    with col2:
        st.video(r"C:\Users\itech\Desktop\data\upi.mp4")
    ...
    Data_Aggregated_Transaction_df= pd.read_csv(r'C:\Users\itech\Desktop\data\myfolder\Data_Aggregated_Transaction_Table.csv')
    Data_Aggregated_User_Summary_df= pd.read_csv(r'C:\Users\itech\Desktop\data\myfolder\Data_Aggregated_User_Summary_Table.csv')
    Data_Aggregated_User_df= pd.read_csv(r'C:\Users\itech\Desktop\data\myfolder\Data_Aggregated_User_Table.csv')
    Scatter_Geo_Dataset =  pd.read_csv(r'C:\Users\itech\Desktop\data\myfolder\Data_Map_Districts_Longitude_Latitude.csv')
    Coropleth_Dataset =  pd.read_csv(r'C:\Users\itech\Desktop\data\myfolder\Data_Map_IndiaStates_TU.csv')
    Data_Map_Transaction_df = pd.read_csv(r'C:\Users\itech\Desktop\data\myfolder\Data_Map_Transaction_Table.csv')
    Data_Map_User_Table= pd.read_csv(r'C:\Users\itech\Desktop\data\myfolder\Data_Map_User_Table.csv')
    Indian_States= pd.read_csv(r'C:\Users\itech\Desktop\data\myfolder\Longitude_Latitude_State_Table.csv')
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video(r"C:\Users\itech\Desktop\data\myfolder\pulse-video.mp4")
    with col2:
        st.image(Image.open(r"C:\Users\itech\Desktop\data\myfolder\PhonePe_Logo.jpg"),width = 500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open(r"C:\Users\itech\Desktop\data\myfolder\top.jpeg"),width = 400)
        with open(r"C:\Users\itech\Desktop\data\annual report.pdf","rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT",data,file_name="annual report.pdf")
    with col2:
        st.image(Image.open(r"C:\Users\itech\Desktop\data\myfolder\report.jpeg"),width = 800)
...
if SELECT == "Contact":
    name = "Harfa Mujawar"
    mail = (f'{"Mail :"}  {"harfamujawar05@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "LINKEDIN": "https://www.linkedin.com/in/prerana-rajangane-a28ab328b/",
        "GITHUB":"https://github.com/preranarajangane18"
        }
    
    col1, col2, col3 = st.columns(3)
    col3.image(Image.open(r"C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\my.jpg.jpeg"), width=350)
    with col2:
